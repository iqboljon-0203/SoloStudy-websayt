...
const Tests = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-900 font-display text-gray-800 dark:text-gray-200 min-h-screen">
      {/* Header */}
