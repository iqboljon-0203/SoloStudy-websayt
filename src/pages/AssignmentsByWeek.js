        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl font-light text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed">
              ...
              formatidagi topshiriqlar bilan bilimingizni mustahkamlang!
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-white/80 to-gray-50/80 dark:from-gray-900/80 dark:to-gray-800/80 backdrop-blur-sm rounded-xl p-4 mb-8 shadow-lg border border-gray-200/50 dark:border-gray-700/50">
            <nav aria-label="Tabs" className="flex gap-6 justify-center">
              <Link
                to="/assignments"
                className="shrink-0 border-b-2 border-transparent px-4 pb-2 text-sm font-medium text-gray-500 dark:text-gray-400 hover:border-gray-300 dark:hover:border-gray-600 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors"
              >
                Fan bo'yicha
              </Link>
              <Link
                to="/assignments/by-week"
                className="shrink-0 border-b-2 border-primary px-4 pb-2 text-sm font-semibold text-primary hover:bg-primary/10 rounded-lg transition-colors"
              >
                Haftalar bo'yicha
              </Link>
            </nav>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                O'zbek tilidagi mustaqil ta'lim platformasi. Talabalar uchun
                zamonaviy ta'lim resurslari.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-sm text-gray-500 dark:text-gray-400">
                © 2025 SoloStudy.uz. Barcha huquqlar himoyalangan.
              </p>
