        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Biz foydalanuvchilarimiz haqidagi ma'lumotlarni juda ehtiyotkorlik
              bilan yig'amiz va saqlaymiz. Faqatgina platformamizning asosiy
              funksiyalarini ta'minlash uchun zarur bo'lgan ma'lumotlarni
              so'raymiz.
            </p>
            <ul className="list-disc pl-6 text-gray-600 dark:text-gray-400 mb-4">
              <li>Shaxsiy ma'lumotlar (ism, elektron pochta)</li>
              <li>O'qish jarayoni bilan bog'liq ma'lumotlar</li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-600 dark:text-gray-400 mb-4">
              <li>Ta'lim jarayonini takomillashtirish</li>
              <li>Platformani yaxshilash va rivojlantirish</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Sizning ma'lumotlaringiz xavfsizligi bizning asosiy
              ustuvorligimizdir. Biz zamonaviy xavfsizlik choralarini qo'llaymiz
              va ma'lumotlaringizni uchinchi shaxslarga bermaymiz.
            </p>
          </section>
